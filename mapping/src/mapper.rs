...
use vecno_indexer_database::models::address_transaction::AddressTransaction as SqlAddressTransaction;
use vecno_indexer_database::models::block::Block as SqlBlock;
use vecno_indexer_database::models::block_parent::BlockParent as SqlBlockParent;
use vecno_indexer_database::models::block_transaction::BlockTransaction as SqlBlockTransaction;
use vecno_indexer_database::models::script_transaction::ScriptTransaction as SqlScriptTransaction;
use vecno_indexer_database::models::transaction::Transaction as SqlTransaction;
use vecno_indexer_database::models::transaction_input::TransactionInput as SqlTransactionInput;
use vecno_indexer_database::models::transaction_output::TransactionOutput as SqlTransactionOutput;
use vecno_indexer_database::models::types::hash::Hash as SqlHash;

use crate::{blocks, transactions};

#[derive(Clone)]
pub struct VecnoDbMapper {
...
impl VecnoDbMapper {
    pub fn new(cli_args: CliArgs) -> VecnoDbMapper {
        VecnoDbMapper {
