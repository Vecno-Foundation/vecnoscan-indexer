...
Please make contact with us on the [Vecno Discord](https://vecnofoundation.org) if you need a pg_dump-file of historical records.
...
### 6. Run indexer
```shell
cargo run -- -s ws://localhost:8110 -d postgres://postgres:newpassword@localhost:5432/vecno --ignore-checkpoint df4120db0755f276b079d66a479ddb58b5fb03ae9ddc2715432beecfab7e8597
```
...
Options:
  -s, --rpc-url <RPC_URL>
          The url to a vecnod instance, e.g 'ws://localhost:17110'. Leave empty to use the Vecno PNN
  -n, --network <NETWORK>
