...
use vecno_indexer_database::models::block::Block;
use vecno_indexer_database::models::block_parent::BlockParent;
...
async fn delete_transaction_acceptances(batch_scale: f64, block_hashes: Vec<SqlHash>, db: VecnoDbClient) -> u64 {
