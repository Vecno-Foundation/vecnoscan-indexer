...
pub async fn load_block_checkpoint(database: &VecnoDbClient) -> Result<String, ()> {
...
pub async fn save_checkpoint(block_hash: &String, database: &VecnoDbClient) -> Result<u64, ()> {
