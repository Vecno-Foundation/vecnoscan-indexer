...
#[openapi(
    info(
        title = "Vecno Indexer REST API",
        license(name = "LICENSE", url = "https://github.com/Vecno-Foundation/vecnoscan-indexer/"),
    ),
    paths(
...
impl WebServer {
    pub fn new(
        ...
        WebServer { settings, signal, metrics, vecnod_pool, database_client, system: Arc::new(RwLock::new(System::new())) }
    }
    ...
    pub async fn run(self: Arc<Self>) -> Result<(), Error> {
        ...
        let app = Router::new()
            ...
            .layer(Extension(self.vecnod_pool.clone()))
